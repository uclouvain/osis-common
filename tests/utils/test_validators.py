...
class TestBelgiumNationalRegisterNumberValidator(SimpleTestCase):
    def test_correct_register_number(self):
        belgium_national_register_number_validator('00 00 00.000-00')

    def test_incorrect_length(self):
        incorrect_length_cases = ['1234567890', '91 12 03.456.7', '20.07.15.999.111']
        for case in incorrect_length_cases:
